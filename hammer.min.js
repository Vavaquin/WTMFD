...
(function(t, e) {
    ...
    i.Instance = function(t, e) {
        ...
        this.element = t,
        this.enabled = !0,
        this.options = i.utils.extend(i.utils.extend({}, i.defaults), e || {}),
    ...
    i.event = {
        ...
        onTouch: function(t, e, n) {
            ...
            this.bindDom(t, i.EVENT_TYPES[e], function(c) {
                ...
                if (!u.match(/mouse/) || !s) {
                    (u.match(/touch/) || u.match(/pointerdown/) || u.match(/mouse/) && 1 === c.which) && (o = !0),
                    ...
                    h > 0 && e == i.EVENT_END ? e = i.EVENT_MOVE : h || (e = i.EVENT_END),
                    h || null === r ? r = c : c = r,
                    n.call(i.detection, a.collectEventData(t, e, c)),
                    i.HAS_POINTEREVENTS && e == i.EVENT_END && (h = i.PointerEvent.updatePointer(e, c))),
                    h || (r = null,
                    o = !1,
                    s = !1,
    ...
    i.PointerEvent = {
        ...
        updatePointer: function(t, e) {
            return t == i.EVENT_END ? this.pointers = {} : (e.identifier = e.pointerId,
            ...
            if (e && t.style) {
                for (var r = 0; i.length > r; r++)
                    for (var o in e)
                        ...
                        i[r] && (n = i[r] + n.substring(0, 1).toUpperCase() + n.substring(1)),
                        t.style[n] = e[o]);
    ...
    i.gestures.Tap = {
        ...
        handler: function(t, e) {
            if (t.eventType == i.EVENT_END) {
                ...
                r = !0),
                (!r || e.options.tap_always) && (i.detection.current.name = "tap",
        ...
        handler: function(t, n) {
            ...
            if (!(n.options.drag_max_touches > 0 && t.touches.length > n.options.drag_max_touches))
                ...
                case i.EVENT_MOVE:
                    ...
                    (n.options.drag_block_vertical && i.utils.isVertical(t.direction) || n.options.drag_block_horizontal && !i.utils.isVertical(t.direction)) && t.preventDefault();
                    break;
                case i.EVENT_END:
        ...
        handler: function(t, n) {
            ...
            if (!(2 > t.touches.length))
                ...
                case i.EVENT_MOVE:
                    ...
                    r > n.options.transform_min_scale && (n.trigger("pinch", t),
                    n.trigger("pinch" + (1 > t.scale ? "in" : "out"), t));
                    break;
                case i.EVENT_END:
                    this.triggered && n.trigger(this.name + "end", t),
                    this.triggered = !1
    ...
    i.gestures.Touch = {
        ...
        handler: function(t, n) {
            ...
            e) : (n.options.prevent_default && t.preventDefault(),
